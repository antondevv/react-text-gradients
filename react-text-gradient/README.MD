...
To find out how to setup the development environment etc, go to [`CONTRIBUTING.MD`](https://github.com/antondevv/react-text-gradient/blob/master/CONTRIBUTING.MD)
